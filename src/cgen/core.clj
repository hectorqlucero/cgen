(ns cgen.core
  (:require
   ...
   [cgen.models.crud :refer [config KEY]]
   [cgen.routes.proutes :refer [proutes]]
   [cgen.routes.routes :refer [open-routes password-routes]]
   [cgen.routes.i18n :refer [i18n-routes]]
   [cgen.routes.tabgrid :refer [tabgrid-routes]]
   [cgen.routes.fk-api :refer [fk-api-routes]]
   [cgen.engine.router :as engine]
