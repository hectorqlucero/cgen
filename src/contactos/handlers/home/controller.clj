(ns contactos.handlers.home.controller
  (:require
   [buddy.hashers :as hashers]
   [clojure.string :as st]
   [contactos.i18n.core :as i18n]
   [contactos.handlers.home.model :refer [get-user get-users update-password]]
   [contactos.handlers.home.view :refer [change-password-view home-view
                                         main-view]]
