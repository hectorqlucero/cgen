(ns contactos.core
  (:require
   ...
   [contactos.models.crud :refer [config KEY]]
   [contactos.routes.proutes :refer [proutes]]
   [contactos.routes.routes :refer [open-routes password-routes]]
   [contactos.routes.i18n :refer [i18n-routes]]
   [contactos.routes.tabgrid :refer [tabgrid-routes]]
   [contactos.routes.fk-api :refer [fk-api-routes]]
   [contactos.engine.router :as engine]
   [contactos.config.loader :as cfg]
